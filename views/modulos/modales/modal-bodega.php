<div class="modal fade" id="modal-nuevo-bodega"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header tituloModal">
        <h5 class="modal-title" id="exampleModalLabel">Nuevo Bodega</h5>
      ...
      <div class="modal-body">
            <form id="formu-nuevo-taller">
                ...
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Nombre Bodega</label>
                    <div class="col-sm-8">
                        <input type="text" id="nombre-taller" class="form-control" placeholder="xxxxx@xxx" required name="nombreBodega">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="dirección" class="form-control" placeholder="xxxxx"  required name="direcciónBodega">
                    </div>
                </div>  
